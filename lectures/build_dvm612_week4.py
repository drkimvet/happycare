...
add_text(s, Inches(0.75), Inches(6.25), Inches(11.9), Inches(0.65), "Willie is the patient we prepare and sedate. MoMo is the patient we do not take to surgery.", size=14, color=NAVY)
...
notes(s, "You do not hand off responsibility at the OR door. Anesthesia prepares the patient for surgical prep. Surgery owns prep through the last skin suture. Both own recovery.")
...
notes(s, "Spend 2 minutes. Highlight Doberman/vWD, brachycephalics, and last meal. Never premedicate before you have examined the patient.")
...
add_bullets(s, Inches(0.5), Inches(1.2), Inches(7.4), Inches(5.5), [
    ...
    "Record it. If it is not written, the next clinician will assume you skipped it.",
], size=16, spacing=10)
...
cases = [
    ...
    ("D", "MoMo: 6 yo SF DSH, 4.25 kg. Acute vomiting ×2, lethargy, construction at home; possible foreign body. T 98.0 °F, HR 200, mm pink tacky. Mildly enlarged abdomen.", "Do not cut yet. Imaging + labs first  ·  this became ASA Status 4-E, not a surgical abdomen", RED_LT, RED),
]
...
add_bullets(s, Inches(4.9), Inches(1.8), Inches(7.6), Inches(4.6), [
    ...
    "Chem day 0: BUN 49.7, creatinine 3.0, phosphorus 8.0. USG 1.042 (concentrating). This is not end-stage isosthenuric CKD that can be ignored.",
...
# CBC/chem → ASA
s = new_content("CBC and chemistry → ASA Status", "These bands inform Status. They do not assign it.")
...
add_bullets(s, Inches(0.5), Inches(1.2), Inches(7.5), Inches(5.5), [
    ...
    "Material risks: anesthesia death (rare but real), hemorrhage, infection, dehiscence, incomplete excision, recurrence. Urinary incontinence after OHE is a real risk in some bitches, especially large-breed bitches. State the risk. Do not omit it and do not inflate it.",
...
add_text(s, Inches(7.1), Inches(1.9), Inches(5.5), Inches(4.4), "Give IV cefazolin 22 mg/kg 30 minutes before incision; redose every 90 minutes if the surgery is still open or blood loss is large.\n\nConsider if:\n• Clean-contaminated / contaminated / dirty\n• Implant (orthopedic, mesh)\n• Hollow viscus entry\n• Surgery >90 minutes or a known break in asepsis\n• Patient immunocompromised\n• Infection would be catastrophic (some neurologic or implant cases. Decide case by case; do not give prophylaxis by habit)", size=15, color=INK)
notes(s, "Elective canine OHE is a clean procedure. Do not prescribe 14 days of cephalexin. Willie’s left ear is infected, so antimicrobials are treatment, not clean prophylaxis.")
...
add_bullets(s, Inches(8.1), Inches(1.75), Inches(4.55), Inches(5.0), [
    ...
    "PVP-I: 5 minutes wet contact, rinse, paint 10% solution, dry. Aqueous CHG: 3 minutes. Do not leave a pool of antiseptic.",
    "Mucosa, conjunctiva, prepuce: 10% PVP-I solution, 1 to 20 to 1 to 50. Eye at 1:50: 2-minute scrub + 2-minute soak.",
    "Never CHG in the eye or middle ear. Willie has a swollen tympanic membrane.",
], size=13, spacing=6)
...
# 31 Never-events
s = new_content("Never-events", "DVM 612 professional standard")
ev = [
...
rows = [
    ...
    ("C", "CHG scrub, then a drop of CHG runs into the eye, then rinse and continue.", "Emergency for the eye. CHG is corneal-toxic. Irrigate with sterile saline immediately. Do not continue the prep over a burned cornea."),
...
notes(s, "C is the safety slide. D: 1 to 20 to 1 to 50, 5 minutes wet on intact skin, 2 minutes plus 2 minutes on the eye. Hair at the drape edge is still a fail. Clip an adequate field. Do not cover hair with a salvage towel.")
...
card(s, Inches(4.7), Inches(1.2), Inches(4.0), Inches(5.5), "Nutrition", "Offer water, then a small bland or usual meal when fully awake (procedure-dependent). GI surgery: surgeon specifies. Cats: prevent hepatic lipidosis. Do not wait days to feed. Consider mirtazapine/capromorelin as directed.", accent=GOLD)
card(s, Inches(8.9), Inches(1.2), Inches(3.9), Inches(5.5), "Other systems", "Urinate before discharge. Bowel movements after laparotomy may lag. Eyes: lubrication after anesthesia. Recheck glucose in diabetics. Walk the dog out. Do not assume the crate is adequate.", accent=GREEN)
...
card(s, Inches(0.45), Inches(1.2), Inches(6.15), Inches(5.5), "Willie, ASA Status 3-E. Proceed with sedation.", "Cavalier, 13.7 kg. Acute vestibular + AS otitis + murmur. Compensated. Fill the anesthesia record. Alfaxalone, monitoring, ear clean, no NSAID after DexSP. Own the next 24 hours. MRI / possible TECA-LBO later. Assign a new ASA status on the day of that surgery.", accent=GOLD)
card(s, Inches(6.75), Inches(1.2), Inches(6.15), Inches(5.5), "MoMo, ASA Status 4-E. Do not induce.", "DSH, 4.25 kg. Vomiting that looked like FB. Labs + POCUS + AUS: structural renal disease, creatinine 3.0 → 4.71 on fluids. Exploratory cancelled. NSAIDs contraindicated. Record the decision. Supportive care, referral, or euthanasia is still a surgical conversation. You do not perform an exploratory.", accent=RED)
